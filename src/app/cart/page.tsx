  ...
  return (
    <div>
      <Container className="py-8">
        ...
        {Boolean(cart.cartTotalQuantity) && (
          <div className="text-2xl font-secondary py-6 font-medium">
            <h2>
              {`Shopping Bag (${cart.cartTotalQuantity} item${
                cart.cartTotalQuantity > 1 ? "s" : ""
              })`}
            </h2>
          </div>
        )}
        ...
        {Boolean(!cart.cartTotalQuantity) && (
          <div className="font-secondary py-6  flex gap-8  flex-col just-cont">
            <div className="text-center ">
              <h2 className="text-2xl font-medium pb-2">
                Shopping Bag Is Currently Empty
              </h2>
              <p>No worries! Our selection suits every taste.</p>
            </div>
            <Button
              onClick={() => router.push("/")}
              size="lg"
